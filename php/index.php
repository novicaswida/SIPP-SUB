  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-grain" aria-hidden="true"></span> SIPP-SUB</a>
        </div>
    ...
    <div class="jumbotron text-center">
      ...
      <h1 style="font-family: arial, sans-serif;">Sistem Informasi Pendistribusian Pupuk Bersubsidi</h1>
      <p style="font-family: arial, sans-serif; font-weight: bold;">Urea | ZA | NPK | Organik</p>
    </div>
    <!-- akhir jumbotron -->
      ...
      <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
          <form>
            ...
            <button type="submit" class="btn btn-primary" style="margin-left: 280px;">Login</button>
          </form>
        </div>
      </div>
    </section>
