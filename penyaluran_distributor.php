    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <!-- <div class="container-fluid"> -->
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="stok_pupukdistibutor.php">Stok Pupuk</a></li>
          <li class="active"><a href="penyaluran_distributor.php">Penyaluran</a></li>
...
select u.id, u.nama, pu.nama_pupuk, sum(p.jumlah) from users u, pupuk pu, penyaluran p
where u.id=p.id_pengecer and pu.id=p.id_pupuk
group by u.id, u.nama, pu.nama_pupuk